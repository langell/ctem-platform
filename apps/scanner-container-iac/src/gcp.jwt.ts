...
import { normalizeGcpPrivateKey } from './container.credential';
import { allowlistedGcpTokenUrl, GCP_TOKEN_URL } from './gcp.egress';

/** Same readonly Artifact Registry scope as GCR inventory. Not cloud-platform, not write. */
 ...
 * the Google token-host allowlist.
 */
export async function exchangeGcpAccessToken(
  ...
  const url = allowlistedGcpTokenUrl(GCP_TOKEN_URL);
