...
describe('azureTokenUrl / azureArmListUrl', () => {
  ...
  it('derives an ARM resource GET on management.azure.com', () => {
    expect(
      azureArmResourceUrl(
        SUB,
        'rg-prod',
      ...
      `https://${AZURE_ARM_HOST}/subscriptions/${SUB}/resourceGroups/rg-prod/providers/Microsoft.Network/networkSecurityGroups/nsg-web?api-version=2024-05-01`,
    );
  });

  it('refuses a URL-shaped resource group', () => {
    expect(() =>
      azureArmResourceUrl(
        SUB,
        'https://evil.example',
